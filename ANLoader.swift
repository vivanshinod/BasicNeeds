...
public struct ANLoader {
    ...
    public static var activityTextFontName: UIFont = UIFont.systemFont(ofSize: 15)
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            ...
            DispatchQueue.main.async {
                if ANLoader.viewBackgroundDark {
                    ...
                    UIView.animate(withDuration: 0.2, animations: {ANLoader.backgroundView.backgroundColor = ANLoader.backgroundView.backgroundColor?.withAlphaComponent(0.0)})
                }
